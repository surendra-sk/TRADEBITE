...
export const FETCH_COIN_MARKET_REQUEST = 'FETCH_COIN_MARKET_REQUEST'
export const FETCH_COIN_MARKET_SUCCESS = "FETCH_COIN_MARKET_SUCCESS";
export const FETCH_COIN_MARKET_FAILURE = "FETCH_COIN_MARKET_FAILURE";
...
export const FETCH_TOP50_COINS_REQUEST = 'FETCH_TOP_COINS_REQUEST'
export const FETCH_TOP50_COINS_SUCCESS = "FETCH_TOP_COINS_SUCCESS";
export const FETCH_TOP50_COINS_FAILURE = "FETCH_TOP_COINS_FAILURE";
